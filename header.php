<?php
    $themeRoot = "/hfkui/wp-content/themes/hfk-wp-theme/";
    $siteRoot = "/hfkui/";
?>
<!DOCTYPE html>
<html>
            ...
            <div class="content-container h-100">
                <div class="pageheader-navbar">
                    <div class="pageheader-logo">
                        <img src="/hfk/assets/hfklogo.png" class="pageheader-logo-primary">
                        <img src="/hfk/assets/hfklogo2.png" class="pageheader-logo-secondary">
                    </div>
